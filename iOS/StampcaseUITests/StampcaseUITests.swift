...
final class StampcaseUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        titleField.tap()
        titleField.typeText("New Stamp")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Stamp"].waitForExistence(timeout: 2))
    }
