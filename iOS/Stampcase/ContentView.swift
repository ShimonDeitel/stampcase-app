            ...
            ZStack {
                ...
                if store.entries.isEmpty {
                    VStack(spacing: 12) {
                        ...
                        Text("Tap + to log your first stamp.")
                            .font(Theme.font(15))
...
struct EntryFormView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existingID == nil ? "Add Stamp" : "Edit Stamp")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry = StampEntry(title: title, detail1: detail1, detail2: detail2, note: note, date: date)
